...
func (this *emptyAppender) Log(extendCallpath int, level string, args ...interface{})   {}
func (this *emptyAppender) Logln(extendCallpath int, level string, args ...interface{}) {}
func (this *emptyAppender) Logf(extendCallpath int, level string, format string, args ...interface{}) {
}
func (this *emptyAppender) SetCallpath(int) {}
